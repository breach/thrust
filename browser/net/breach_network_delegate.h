...
class BreachNetworkDelegate : public net::NetworkDelegate {
 public:
  BreachNetworkDelegate();
  virtual ~BreachNetworkDelegate();
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(BreachNetworkDelegate);
};
