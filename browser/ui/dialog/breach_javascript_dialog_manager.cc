...
BreachJavaScriptDialogManager::BreachJavaScriptDialogManager() 
{
}
...
void 
BreachJavaScriptDialogManager::RunJavaScriptDialog(
...
void 
BreachJavaScriptDialogManager::RunBeforeUnloadDialog(
    WebContents* web_contents,
    const string16& message_text,
    bool is_reload,
    const DialogClosedCallback& callback) 
...
void 
BreachJavaScriptDialogManager::DialogClosed(
