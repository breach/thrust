...
#ifndef EXO_BROWSER_BROWSER_UI_COCOA_EVENT_PROCESSING_WINDOW_H_
#define EXO_BROWSER_BROWSER_UI_COCOA_EVENT_PROCESSING_WINDOW_H_
...
#endif  // EXO_BROWSER_BROWSER_UI_COCOA_EVENT_PROCESSING_WINDOW_H_
