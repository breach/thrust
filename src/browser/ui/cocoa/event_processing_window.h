...
#ifndef THRUST_SHELL_BROWSER_UI_COCOA_EVENT_PROCESSING_WINDOW_H_
#define THRUST_SHELL_BROWSER_UI_COCOA_EVENT_PROCESSING_WINDOW_H_
...
#endif  // THRUST_SHELL_BROWSER_UI_COCOA_EVENT_PROCESSING_WINDOW_H_
