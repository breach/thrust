...
// static
std::string 
GlobalMenuBarX11::GetPathForWindow(
    gfx::AcceleratedWidget xid) 
{
  return base::StringPrintf("/com/canonical/menu/%lX", xid);
}

void 
GlobalMenuBarX11::SetMenu(
...
bool 
GlobalMenuBarX11::IsServerStarted() const 
{
  return server_;
}

void 
GlobalMenuBarX11::InitServer(
    gfx::AcceleratedWidget xid) 
{
...
void 
GlobalMenuBarX11::BuildMenuFromModel(
    ui::MenuModel* model,
    DbusmenuMenuitem* parent) 
{
...
void 
GlobalMenuBarX11::RegisterAccelerator(
    DbusmenuMenuitem* item,
...
void 
GlobalMenuBarX11::OnItemActivated(
    DbusmenuMenuitem* item,
...
void 
GlobalMenuBarX11::OnSubMenuShow(
    DbusmenuMenuitem* item) 
{
  int id;
  ui::MenuModel* model = ModelForMenuItem(item);
