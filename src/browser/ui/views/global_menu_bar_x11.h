...
#ifndef EXO_BROWSER_BROWSER_UI_VIEWS_GLOBAL_MENU_BAR_X11_H_
#define EXO_BROWSER_BROWSER_UI_VIEWS_GLOBAL_MENU_BAR_X11_H_
...
#endif  // EXO_BROWSER_BROWSER_UI_VIEWS_GLOBAL_MENU_BAR_X11_H_
