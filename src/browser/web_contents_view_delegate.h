...
#ifndef EXO_BROWSER_BROWSER_WEB_CONTENTS_VIEW_DELEGATE_H_
#define EXO_BROWSER_BROWSER_WEB_CONTENTS_VIEW_DELEGATE_H_
...
#endif // EXO_BROWSER_BROWSER_WEB_CONTENTS_VIEW_DELEGATE_H_
