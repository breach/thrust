...
@interface ExoShellWindowDelegate : NSObject<NSWindowDelegate> {
 @private
  exo_shell::ExoShell* browser_;
}
- (id)initWithExoShell:(exo_shell::ExoShell*)browser;
@end
...
- (void) setExoShell:(exo_shell::ExoShell*) browser;
@end
    ...
    const std::string& icon_path)
{
  ...
  ExoShellWindowDelegate* delegate =
      [[ExoShellWindowDelegate alloc] initWithExoShell:this];
