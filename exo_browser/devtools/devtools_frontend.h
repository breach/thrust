...
#ifndef EXO_BROWSER_DEVTOOLS_FRONTEND_H_
#define EXO_BROWSER_DEVTOOLS_FRONTEND_H_
...
class ExoBrowserDevToolsFrontend : 
 ...
 public:
  static ExoBrowserDevToolsFrontend* Show(
 ...
 private:
  ...
  virtual ~ExoBrowserDevToolsFrontend();
  ...
  DISALLOW_COPY_AND_ASSIGN(ExoBrowserDevToolsFrontend);
};

} // namespace exo_browser

#endif // EXO_BROWSER_DEVTOOLS_FRONTEND_H_
